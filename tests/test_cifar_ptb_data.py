...
def submit_cifar10():
    def unpickle(file):
        ...
        return dict
    X_true = (unpickle("data/cifar-10-batches-py/data_batch_1")[b'data']/255)[0]
    X_test = (unpickle("data/cifar-10-batches-py/test_batch")[b'data']/255)[0]
